---
title: "Survival Analysis P2: Survival and Hazard Functions"
...
survplot$plot +
  ...
  labs(caption = "Figure 1: Survival Function For all Patients") +
  theme(
    axis.line = element_blank(),
    panel.grid.minor = element_blank(),
    plot.caption = element_text(hjust = 0, face = "italic", size = 12, margin = margin(t = 10))
  )
