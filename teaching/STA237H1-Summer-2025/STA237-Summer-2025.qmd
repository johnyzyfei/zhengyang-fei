...
**c)**
Since $$\mathbb{P}(1 < Y \leq 2) = F_Y(2) - F_Y(1)$$ So then from part b, we can compute
...
Thus, 
$$\mathbb{P}(1 < Y \leq 2) = 1 - \frac{3}{4} = \boxed{\frac{1}{4}}$$
...
$$F_X(x) = 1 - e^{-2x}, \quad x \geq 0$$

Let \( U \sim \text{Uniform}(0, 1) \), and solve:
\begin{align*}
U &= 1 - e^{-2x} \\
e^{-2x} &= 1 - U \\
-2x &= \ln(1 - U) \\
